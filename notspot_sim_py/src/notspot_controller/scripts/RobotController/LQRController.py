...
class LQR_controller(object):
    def __init__(self):
        ...
        self.control_alpha = 0.6    # Smoothing factor for control outputs was 0.3 for controller
        ...
        self.gain_factor = 1.0  # Adjusted based on actual inertia values was 0.18 for controller
